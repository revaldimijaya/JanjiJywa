        ...
        <div class="max-w-7xl mx-auto px-4 text-center sm:px-6 lg:px-8">
            <div class="space-y-12">
                ...
                <ul class="mx-auto space-y-16 sm:grid sm:grid-cols-2 sm:gap-16 sm:space-y-0 lg:grid-cols-3 lg:max-w-5xl">
                    <li>
                        <div class="space-y-6">
                            <img class="mx-auto h-40 w-40 rounded-full xl:w-56 xl:h-56" src="/storage/profile/CEO.jpg" alt="">
                            <div class="space-y-2">
                    ...
                    <li>
                        <div class="space-y-6">
                            <img class="mx-auto h-40 w-40 rounded-full xl:w-56 xl:h-56" src="/storage/profile/admin.jpg" alt="">
                            <div class="space-y-2">
                                <div class="text-lg leading-6 font-medium space-y-1">
                                    <h3>Ay U</h3>
                    ...
                    <li>
                        <div class="space-y-6">
                            <img class="mx-auto h-40 w-40 rounded-full xl:w-56 xl:h-56" src="/storage/profile/admin2.jpg" alt="">
                            <div class="space-y-2">
                                <div class="text-lg leading-6 font-medium space-y-1">
                                    <h3>Revaldi Mijaya</h3>
                                    <p class="text-indigo-600">Admin</p>
